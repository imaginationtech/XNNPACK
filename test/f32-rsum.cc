...
#include "rsum-microkernel-tester.h"
...
#if XNN_ENABLE_RISCV_VECTOR && XNN_ARCH_RISCV
  TEST(F32_RSUM__RVV_U2V, batch_eq_2v) {
    TEST_REQUIRES_RISCV_VECTOR;
    RSumMicrokernelTester()
      .batch_size(2 * xnn_init_hardware_config()->vlenb / sizeof(float))
      .Test(xnn_f32_rsum_ukernel__rvv_u2v, xnn_init_f32_scale_scalar_params);
  }

  TEST(F32_RSUM__RVV_U2V, batch_div_2v) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(F32_RSUM__RVV_U2V, batch_lt_2v) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1;
                batch_size < 2 * xnn_init_hardware_config()->vlenb / sizeof(float);
                batch_size++) {
  ...
  TEST(F32_RSUM__RVV_U2V, batch_gt_2v) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(F32_RSUM__RVV_U2V, scale) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (float scale = 0.3f; scale < 5.0f; scale *= 3.0f) {
      RSumMicrokernelTester()
        .batch_size(2 * xnn_init_hardware_config()->vlenb / sizeof(float) + 1)
        .scale(scale)
        .Test(xnn_f32_rsum_ukernel__rvv_u2v, xnn_init_f32_scale_scalar_params);
    }
  }

  TEST(F32_RSUM__RVV_U2V, overflow_accumulator) {
    TEST_REQUIRES_RISCV_VECTOR;
    RSumMicrokernelTester()
      .batch_size(256)
      .Test(xnn_f32_rsum_ukernel__rvv_u2v, xnn_init_f32_scale_scalar_params);
...
#if XNN_ENABLE_RISCV_VECTOR && XNN_ARCH_RISCV
  TEST(F32_RSUM__RVV_U4V, batch_eq_4v) {
    TEST_REQUIRES_RISCV_VECTOR;
    RSumMicrokernelTester()
      .batch_size(4 * xnn_init_hardware_config()->vlenb / sizeof(float))
      .Test(xnn_f32_rsum_ukernel__rvv_u4v, xnn_init_f32_scale_scalar_params);
  }

  TEST(F32_RSUM__RVV_U4V, batch_div_4v) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(F32_RSUM__RVV_U4V, batch_lt_4v) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1;
                batch_size < 4 * xnn_init_hardware_config()->vlenb / sizeof(float);
                batch_size++) {
  ...
  TEST(F32_RSUM__RVV_U4V, batch_gt_4v) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(F32_RSUM__RVV_U4V, scale) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (float scale = 0.3f; scale < 5.0f; scale *= 3.0f) {
      RSumMicrokernelTester()
        .batch_size(4 * xnn_init_hardware_config()->vlenb / sizeof(float) + 1)
        .scale(scale)
        .Test(xnn_f32_rsum_ukernel__rvv_u4v, xnn_init_f32_scale_scalar_params);
    }
  }

  TEST(F32_RSUM__RVV_U4V, overflow_accumulator) {
    TEST_REQUIRES_RISCV_VECTOR;
    RSumMicrokernelTester()
      .batch_size(512)
      .Test(xnn_f32_rsum_ukernel__rvv_u4v, xnn_init_f32_scale_scalar_params);
...
#if XNN_ENABLE_RISCV_VECTOR && XNN_ARCH_RISCV
  TEST(F32_RSUM__RVV_U8V, batch_eq_8v) {
    TEST_REQUIRES_RISCV_VECTOR;
    RSumMicrokernelTester()
      .batch_size(8 * xnn_init_hardware_config()->vlenb / sizeof(float))
      .Test(xnn_f32_rsum_ukernel__rvv_u8v, xnn_init_f32_scale_scalar_params);
  }

  TEST(F32_RSUM__RVV_U8V, batch_div_8v) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(F32_RSUM__RVV_U8V, batch_lt_8v) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1;
                batch_size < 8 * xnn_init_hardware_config()->vlenb / sizeof(float);
                batch_size++) {
  ...
  TEST(F32_RSUM__RVV_U8V, batch_gt_8v) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(F32_RSUM__RVV_U8V, scale) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (float scale = 0.3f; scale < 5.0f; scale *= 3.0f) {
      RSumMicrokernelTester()
        .batch_size(8 * xnn_init_hardware_config()->vlenb / sizeof(float) + 1)
        .scale(scale)
        .Test(xnn_f32_rsum_ukernel__rvv_u8v, xnn_init_f32_scale_scalar_params);
    }
  }

  TEST(F32_RSUM__RVV_U8V, overflow_accumulator) {
    TEST_REQUIRES_RISCV_VECTOR;
    RSumMicrokernelTester()
      .batch_size(1024)
      .Test(xnn_f32_rsum_ukernel__rvv_u8v, xnn_init_f32_scale_scalar_params);
