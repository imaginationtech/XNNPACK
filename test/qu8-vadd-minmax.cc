...
#include "vbinary-microkernel-tester.h"
  ...
  TEST(QU8_VADD_MINMAX__RVV_U1V, batch_eq_1) {
    TEST_REQUIRES_RISCV_VECTOR;
    VBinaryMicrokernelTester()
      .batch_size(1)
      .Test(xnn_qu8_vadd_minmax_ukernel__rvv_u1v, xnn_init_qu8_add_minmax_rvv_params);
  }

  TEST(QU8_VADD_MINMAX__RVV_U1V, batch_gt_1) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(QU8_VADD_MINMAX__RVV_U1V, inplace_a) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(QU8_VADD_MINMAX__RVV_U1V, inplace_b) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 5; batch_size += 1) {
      VBinaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QU8_VADD_MINMAX__RVV_U1V, inplace_a_and_b) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 5; batch_size += 1) {
      VBinaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QU8_VADD_MINMAX__RVV_U1V, a_zero_point) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 5; batch_size += 1) {
      for (int32_t a_zero_point = -128; a_zero_point <= 127; a_zero_point += 51) {
        VBinaryMicrokernelTester()
  ...
  TEST(QU8_VADD_MINMAX__RVV_U1V, b_zero_point) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 5; batch_size += 1) {
      for (int32_t b_zero_point = -128; b_zero_point <= 127; b_zero_point += 51) {
        VBinaryMicrokernelTester()
  ...
  TEST(QU8_VADD_MINMAX__RVV_U1V, y_zero_point) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 5; batch_size += 1) {
      for (int32_t y_zero_point = -128; y_zero_point <= 127; y_zero_point += 51) {
        VBinaryMicrokernelTester()
  ...
  TEST(QU8_VADD_MINMAX__RVV_U1V, a_scale) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 5; batch_size += 1) {
      for (float a_scale = 0.1f; a_scale <= 10.0f; a_scale *= 3.14f) {
        VBinaryMicrokernelTester()
  ...
  TEST(QU8_VADD_MINMAX__RVV_U1V, b_scale) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 5; batch_size += 1) {
      for (float b_scale = 0.1f; b_scale <= 10.0f; b_scale *= 3.14f) {
        VBinaryMicrokernelTester()
  ...
  TEST(QU8_VADD_MINMAX__RVV_U1V, y_scale) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 5; batch_size += 1) {
      for (float y_scale = 0.1f; y_scale <= 10.0f; y_scale *= 3.14f) {
        VBinaryMicrokernelTester()
  ...
  TEST(QU8_VADD_MINMAX__RVV_U1V, qmin) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 5; batch_size += 1) {
      VBinaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QU8_VADD_MINMAX__RVV_U1V, qmax) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 5; batch_size += 1) {
      VBinaryMicrokernelTester()
        .batch_size(batch_size)
...
#if XNN_ENABLE_RISCV_VECTOR && XNN_ARCH_RISCV
  TEST(QU8_VADD_MINMAX__RVV_U2V, batch_eq_2) {
    TEST_REQUIRES_RISCV_VECTOR;
    VBinaryMicrokernelTester()
      .batch_size(2)
      .Test(xnn_qu8_vadd_minmax_ukernel__rvv_u2v, xnn_init_qu8_add_minmax_rvv_params);
  }

  TEST(QU8_VADD_MINMAX__RVV_U2V, batch_div_2) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(QU8_VADD_MINMAX__RVV_U2V, batch_lt_2) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(QU8_VADD_MINMAX__RVV_U2V, batch_gt_2) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(QU8_VADD_MINMAX__RVV_U2V, inplace_a) {
    TEST_REQUIRES_RISCV_VECTOR;
  ...
  TEST(QU8_VADD_MINMAX__RVV_U2V, inplace_b) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 10; batch_size += 1) {
      VBinaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QU8_VADD_MINMAX__RVV_U2V, inplace_a_and_b) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 10; batch_size += 1) {
      VBinaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QU8_VADD_MINMAX__RVV_U2V, a_zero_point) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 10; batch_size += 1) {
      for (int32_t a_zero_point = -128; a_zero_point <= 127; a_zero_point += 51) {
        VBinaryMicrokernelTester()
  ...
  TEST(QU8_VADD_MINMAX__RVV_U2V, b_zero_point) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 10; batch_size += 1) {
      for (int32_t b_zero_point = -128; b_zero_point <= 127; b_zero_point += 51) {
        VBinaryMicrokernelTester()
  ...
  TEST(QU8_VADD_MINMAX__RVV_U2V, y_zero_point) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 10; batch_size += 1) {
      for (int32_t y_zero_point = -128; y_zero_point <= 127; y_zero_point += 51) {
        VBinaryMicrokernelTester()
  ...
  TEST(QU8_VADD_MINMAX__RVV_U2V, a_scale) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 10; batch_size += 1) {
      for (float a_scale = 0.1f; a_scale <= 10.0f; a_scale *= 3.14f) {
        VBinaryMicrokernelTester()
  ...
  TEST(QU8_VADD_MINMAX__RVV_U2V, b_scale) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 10; batch_size += 1) {
      for (float b_scale = 0.1f; b_scale <= 10.0f; b_scale *= 3.14f) {
        VBinaryMicrokernelTester()
  ...
  TEST(QU8_VADD_MINMAX__RVV_U2V, y_scale) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 10; batch_size += 1) {
      for (float y_scale = 0.1f; y_scale <= 10.0f; y_scale *= 3.14f) {
        VBinaryMicrokernelTester()
  ...
  TEST(QU8_VADD_MINMAX__RVV_U2V, qmin) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 10; batch_size += 1) {
      VBinaryMicrokernelTester()
        .batch_size(batch_size)
  ...
  TEST(QU8_VADD_MINMAX__RVV_U2V, qmax) {
    TEST_REQUIRES_RISCV_VECTOR;
    for (size_t batch_size = 1; batch_size <= 10; batch_size += 1) {
      VBinaryMicrokernelTester()
        .batch_size(batch_size)
