...
#include "xnnpack/vcvt.h"
  ...
  BENCHMARK_CAPTURE(qs8_f32_vcvt, rvv_u1v,
                    xnn_qs8_f32_vcvt_ukernel__rvv_u1v,
                    xnn_init_qs8_f32_cvt_rvv_params,
...
#if XNN_ENABLE_RISCV_VECTOR && XNN_ARCH_RISCV
  BENCHMARK_CAPTURE(qs8_f32_vcvt, rvv_u2v,
                    xnn_qs8_f32_vcvt_ukernel__rvv_u2v,
                    xnn_init_qs8_f32_cvt_rvv_params,
                    benchmark::utils::CheckRVV)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<int8_t, float>)
    ->UseRealTime();
